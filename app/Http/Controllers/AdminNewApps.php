...
class AdminNewApps extends Controller
{
    ...
    public function approve(Request $request)
    {
        ...
        $application_exists_no = Outcome::where('application_id', '=', $application_id)->get()->count();
...
//        if there is no other application in the outcome table with the same id issue cert
        ...
        DB::update('update new_applicants set status = ? where id = ?',['approved',$application_id]);
...
//        if there is no other application in the outcome table with the same id issue cert
        ...
        DB::update('update new_applicants set status = ? where id = ?',['rejected',$application_id]);
