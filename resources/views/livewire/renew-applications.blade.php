    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form method="POST" action="dashboard_new_apps" enctype="multipart/form-data">
                     @csrf
                 <select name="status">
                ...
                <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    @foreach($applications as $application)
                        <tr class="gradeX">
                            ...
                            <td class="center"><a href="/dashboard_renew_apps_id_{{$application->id}}"> <i class="fa fa-eye"></i></a> </td>
                        </tr>
                    @endforeach
                    </tfoot>
                </table>
