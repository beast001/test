    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4">
            <div class="title-action">
                ...
                <a href="/print_cert" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Invoice </a>
            </div>
        </div>
    </div>
                ...
                <div class="ibox-content p-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5>From:</h5>
                            <address>
                                <strong>ICT Authority.</strong><br>
                                Teleposta Towers, 12th Flr,<br>
                                Kenyatta Ave, Nairobi, Kenya.<br>
                                <abbr title="Phone">P:</abbr> (254) 20-211960/61
                            </address>
                        </div>
